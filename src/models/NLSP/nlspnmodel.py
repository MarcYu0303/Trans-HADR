...
from models.NLSP.common import *
from models.NLSP.modulated_deform_conv_func import ModulatedDeformConvFunction
import torch
...
class NLSPN(nn.Module):
    ...
    def forward(self, feat_init, guidance, confidence=None, feat_fix=None,
        ...
        # Propagation
        if self.args.preserve_input and feat_fix is not None:
            ...
            # if self.args.preserve_high_confidence:
            #     mask_fix = mask_fix + (confidence > self.args.high_confidence_threshold).type_as(feat_fix)
        # mask_fix = (confidence > self.args.high_confidence_threshold).type_as(feat_fix)
