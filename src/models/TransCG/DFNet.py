...
from models.TransCG.dense import DenseBlock
from models.TransCG.duc import DenseUpsamplingConvolution
...
if __name__ == '__main__':
    rgb = torch.randn(8, 3, 240, 320)
    depth = torch.randn(8, 240, 320)
    net = DFNet()
